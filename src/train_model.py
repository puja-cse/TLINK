...
def train_loop( ):
    ...
    for batch in dataloader:
        ...
        optimizer.zero_grad()
        #loss = loss_fn(input=y_logits, target=y, weight=class_weights) 
...
if __name__ == "__main__":
    ...
    #print(f"data types: {train_loss[0].is_cuda()}, {type(val_loss[0]), {type(val_macro_f1[0])}, {type(val_micro_f1[0])}}")
